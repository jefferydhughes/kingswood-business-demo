...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_users_roles" AS ENUM('editor', 'publisher', 'administrator');
  CREATE TYPE "public"."enum_pages_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__pages_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_programs_delivery_modes" AS ENUM('campus', 'online', 'hybrid');
  CREATE TYPE "public"."enum_programs_study_level" AS ENUM('undergraduate', 'graduate', 'certificate', 'gap-year');
  CREATE TYPE "public"."enum_programs_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__programs_v_version_delivery_modes" AS ENUM('campus', 'online', 'hybrid');
  CREATE TYPE "public"."enum__programs_v_version_study_level" AS ENUM('undergraduate', 'graduate', 'certificate', 'gap-year');
  ...
  CREATE TABLE "programs_delivery_modes" (
  	"order" integer NOT NULL,
  	"parent_id" integer NOT NULL,
  	"value" "enum_programs_delivery_modes",
  	"id" serial PRIMARY KEY NOT NULL
  );
  ...
  CREATE TABLE "programs" (
  	...
  	"title" varchar,
  	"slug" varchar,
  	"study_level" "enum_programs_study_level",
  	"credential" varchar,
  	"short_value_proposition" varchar,
  	"overview" jsonb,
  	"duration" varchar,
  	"credits" numeric,
  	"curriculum_u_r_l" varchar,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"_status" "enum_programs_status" DEFAULT 'draft'
  );
  
  CREATE TABLE "_programs_v_version_delivery_modes" (
  	"order" integer NOT NULL,
  	"parent_id" integer NOT NULL,
  	"value" "enum__programs_v_version_delivery_modes",
  	"id" serial PRIMARY KEY NOT NULL
  );
  ...
  CREATE TABLE "_programs_v" (
  	...
  	"version_title" varchar,
  	"version_slug" varchar,
  	"version_study_level" "enum__programs_v_version_study_level",
  	"version_credential" varchar,
  	"version_short_value_proposition" varchar,
  	"version_overview" jsonb,
  	"version_duration" varchar,
  	"version_credits" numeric,
  	"version_curriculum_u_r_l" varchar,
  	"version_updated_at" timestamp(3) with time zone,
  	"version_created_at" timestamp(3) with time zone,
  ...
  CREATE TABLE "site_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"institution_name" varchar DEFAULT 'Kingswood University',
  	"default_meta_description" varchar,
  	"admissions_u_r_l" varchar,
  	"application_u_r_l" varchar,
  ...
  CREATE TABLE "_site_settings_v" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"version_institution_name" varchar DEFAULT 'Kingswood University',
  	"version_default_meta_description" varchar,
  	"version_admissions_u_r_l" varchar,
  	"version_application_u_r_l" varchar,
  ...
  ALTER TABLE "programs_delivery_modes" ADD CONSTRAINT "programs_delivery_modes_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."programs"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_programs_v_version_delivery_modes" ADD CONSTRAINT "_programs_v_version_delivery_modes_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."_programs_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "programs_delivery_modes_order_idx" ON "programs_delivery_modes" USING btree ("order");
  CREATE INDEX "programs_delivery_modes_parent_idx" ON "programs_delivery_modes" USING btree ("parent_id");
  ...
  CREATE INDEX "_programs_v_version_delivery_modes_order_idx" ON "_programs_v_version_delivery_modes" USING btree ("order");
  CREATE INDEX "_programs_v_version_delivery_modes_parent_idx" ON "_programs_v_version_delivery_modes" USING btree ("parent_id");
  ...
  CREATE INDEX "_programs_v_autosave_idx" ON "_programs_v" USING btree ("autosave");
...
export async function down({ db }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "programs_delivery_modes" CASCADE;
  DROP TABLE "programs" CASCADE;
  DROP TABLE "_programs_v_version_delivery_modes" CASCADE;
  ...
  DROP TYPE "public"."enum_programs_delivery_modes";
  DROP TYPE "public"."enum_programs_study_level";
  DROP TYPE "public"."enum_programs_status";
  DROP TYPE "public"."enum__programs_v_version_delivery_modes";
  DROP TYPE "public"."enum__programs_v_version_study_level";
